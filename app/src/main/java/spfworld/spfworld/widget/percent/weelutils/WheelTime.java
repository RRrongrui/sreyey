package spfworld.spfworld.widget.percent.weelutils;
...
import spfworld.spfworld.widget.percent.view.WheelView;
		...
		OnItemSelectedListener wheelListener_month = new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				...
				if (list_big.contains(String.valueOf(month_num))) {
					...
					if (((wv_year.getCurrentItem() + startYear) % 4 == 0
							&& (wv_year.getCurrentItem() + startYear) % 100 != 0)
