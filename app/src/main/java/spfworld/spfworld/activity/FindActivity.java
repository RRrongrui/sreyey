...
import spfworld.spfworld.fragment.find.FindFragment;
...
public class FindActivity extends AppCompatActivity  {
    ...
    private  final int MAIN_CONTENT_SPACE_ID=R.id.find_fragment;
    ...
    public List<Fragment> iniFragmentList() {
        ...
        FT.add(MAIN_CONTENT_SPACE_ID, findFragment, "发现_TAG=0");
