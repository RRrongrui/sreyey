...
public class Utils {
	...
	public static List<CityBean> getCityList(Context context) {
		List<CityBean> mCitys = null;
		String str = AbFileUtil.readAssetsByName(context, "region_structured.json", "utf-8");
		AbLogUtil.i("oye", AbStrUtil.parseEmpty(str));

//		if (str != null) {
//			mCitys = GsonTools.changeGsonToList(str,CityBean.class);
//		}
		return mCitys;
	}
}
