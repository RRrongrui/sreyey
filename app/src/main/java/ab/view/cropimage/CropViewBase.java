...
public abstract class CropViewBase extends ImageView {
	...
	// This is the base transformation which is used to show the collont_item
	// initially. The current computation for this shows the collont_item in
	// it's entirety, letterboxing as needed. One could choose to
	// show the collont_item as cropped instead.
	//
	// This matrix is recomputed when we go from the thumbnail collont_item to
	// the full size collont_item.
	/** The m base matrix. */
	...
	//
	// This matrix remains the same when we go from the thumbnail collont_item
	// to the full size collont_item.
	/** The m supp matrix. */
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && getScale() > 1.0f) {
			...
			// collont_item, otherwise Back returns the user to the gallery.
			zoomTo(1.0f);
			return true;
		}
	 ...
	 *
	 * @version v1.0
	 * @param bitmap the new collont_item bitmap
	...
	/**
	 * Sets the collont_item bitmap reset base.
	 *
	 * @param bitmap the bitmap
	...
	/**
	 * Sets the collont_item rotate bitmap reset base.
	 *
	 * @param bitmap the bitmap
	 * @param resetSupp the reset supp
	 */
	...
	// defined as follows: if the collont_item is scaled down below the
	// view's dimensions then center it (literally). If the collont_item
	...
	// Setup the base matrix so that the collont_item is centered and scaled properly.
	/**
	...
	/**
	 * Gets the collont_item view matrix.
	 *
	 * @return the collont_item view matrix
	 */
	...
	// is calculated to show the collont_item at 400% zoom regardless of screen or
	// collont_item orientation. If in the future we decode the full 3 megapixel collont_item,
