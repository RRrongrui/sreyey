...
// overlayed with the collont_item. There are two coordinate spaces in use. One is
// collont_item, another is screen. computeLayout() uses mMatrix to map from collont_item
...
public class HighlightView {
    ...
    /** The m context. */
    View mContext; // The View displaying the collont_item.
     ...
     */
    private void init() {
        mResizeDrawableDiagonal = AbImageUtil.bitmapToDrawable(AbFileUtil.getBitmapFromSrc("collont_item/crop_big.png"));
        mResizeDrawableDiagonal2 = AbImageUtil.bitmapToDrawable(AbFileUtil.getBitmapFromSrc("collont_item/crop_small.png"));
    }
...
//                    mResizeDrawableHeight.draw(canvas);
    ...
    public void handleMotion(int edge, float dx, float dy) {
        ...
        if (edge == GROW_NONE) {
            ...
            // Convert to collont_item space before sending to moveBy().
            ...
            // Convert to collont_item space before sending to growBy().
    ...
    // Grows the cropping rectange by (dx, dy) in collont_item space.
    /**
     * Move by.
     *
     * @param dx the dx
    ...
    void moveBy(float dx, float dy) {
        ...
        // Put the cropping rectangle inside collont_item rectangle.
...
//        mContext.invalidate(invalRect);
    ...
    void growBy(float dx, float dy) {
        ...
        // Grow at most half of the difference between the collont_item rectangle and
...
//            r.inset(0F, -(heightCap - r.height()) / 2F);
        ...
        // Put the cropping rectangle inside the collont_item rectangle.
    ...
    // Returns the cropping rectangle in collont_item space.
    /**
     * Gets the crop rect.
     *
    ...
    // Maps the cropping rectangle from collont_item space to screen space.
    /**
     * Compute layout.
     *
     * @return the rect
     ...
     *
     * @param m the m
     * @param imageRect the collont_item rect
 ...
 Grow
    ...
    /** The m collont_item rect. */
    public RectF mImageRect; // in collont_item space
    
    /** The m crop rect. */
    public RectF mCropRect; // in collont_item space
