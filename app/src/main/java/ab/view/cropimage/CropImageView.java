...
public class CropImageView extends CropViewBase {
     ...
     * @see CropViewBase#onLayout(boolean, int, int, int, int)
     * @author: amsoft.cn
    ...
    /**
     * Instantiates a new crop collont_item view.
     *
     ...
     * @see CropViewBase#zoomTo(float, float, float)
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
     ...
     * @see CropViewBase#postTranslate(float, float)
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            // the user to move the collont_item around. This call to center puts
    ...
    // Pan the displayed collont_item to make sure the cropping rectangle is visible.
    /**
     * Ensure visible.
     *
     * @param hv the hv
    ...
    /**
     * Sets the crop collont_item.
     *
     * @param cropImage the new crop collont_item
     */
