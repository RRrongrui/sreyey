...
public class AbMultiColumnListView extends ScrollView{
   ...
   public OnScrollListener getOnScrollListener() {
    ...
    /**
     * Gets the release collont_item res ids.
     *
     * @return the release collont_item res ids
     */
	...
	/**
	 * Sets the release collont_item res ids.
	 *
	 * @param releaseImageResIds the new release collont_item res ids
	 */
