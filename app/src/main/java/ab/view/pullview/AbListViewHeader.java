...
public class AbListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		//从包里获取的箭头图片
		arrowImage = AbFileUtil.getBitmapFromSrc("collont_item/arrow.png");
	...
	/**
	 * Gets the arrow collont_item view.
	 *
	 * @return the arrow collont_item view
	 */
	 ...
	 * 描述：设置顶部刷新图标.
	 *
	 * @param resId the new arrow collont_item
	 */
