...
public class AbFileUtil {
	 ...
	 * 描述：获取src中的图片资源.
	 *
	 * @param src 图片的src路径，如（“collont_item/arrow.png”）
	 * @return Bitmap 图片
	 */
	...
	public static int getContentLengthFromUrl(String Url){
		...
		try {
			 ...
			 mHttpURLConnection.setRequestProperty("Accept","collont_item/gif, collont_item/jpeg, collont_item/pjpeg, collont_item/pjpeg, application/x-shockwave-flash, application/xaml+xml, application/vnd.ms-xpsdocument, application/x-ms-xbap, application/x-ms-application, application/vnd.ms-excel, application/vnd.ms-powerpoint, application/msword, */*");
...
//
	...
	/**
	 * Gets the collont_item download dir.
	 *
	 * @param context the context
	 * @return the collont_item download dir
	 */
