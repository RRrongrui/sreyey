...
public class AbAnimationUtil {
	...
	public static void playRotateAnimation2(View v, long durationMillis) {
	...
	public static void playScafeAnimation(final View v, long durationMillis) {
		// 创建AnimationSet对象
		v.setVisibility(View.VISIBLE);
		AnimationSet animationSet = new AnimationSet(true);
		ScaleAnimation sa = new ScaleAnimation(1.0f, 1.3f,
				1.0f, 1.3f, Animation.RELATIVE_TO_SELF, 0,
				Animation.RELATIVE_TO_SELF, 0);
		sa.setDuration(durationMillis);
		// Animation.RESTART
		sa.setRepeatMode(0);
		// 动画插入器
		sa.setInterpolator(v.getContext(),
				android.R.anim.decelerate_interpolator);
		...
		aa.setRepeatMode(0);
		// 动画插入器
		aa.setInterpolator(v.getContext(),
				android.R.anim.decelerate_interpolator);
		// 添加到AnimationSet
	...
	public static void playScafeAnimation2(final View v, long durationMillis) {
		// 创建AnimationSet对象
		AnimationSet animationSet = new AnimationSet(true);
		ScaleAnimation sa = new ScaleAnimation(1.0f, 1.3f,
				1.0f, 1.3f, Animation.RELATIVE_TO_SELF, 0,
